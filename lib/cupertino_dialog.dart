            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: InkWell(
                  child: Align(
                    ...
                    child: Text("Alert Dialog Simple", style: TextStyle(
              ...
              SizedBox(
                ...
                child: InkWell(
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text("Alert Dialog Info", style: TextStyle(color: Colors.grey[700], fontWeight: FontWeight.w500)),
                  ),
                  onTap: () {
              ...
              SizedBox(
                ...
                child: InkWell(
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text("Alert Dialog Selection", style: TextStyle(
                        color: Colors.grey[700], fontWeight: FontWeight.w500
                    )),
                  ),
                  onTap: () {
              ...
              SizedBox(
                ...
                child: InkWell(
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text("Action Sheet", style: TextStyle(
                        color: Colors.grey[700], fontWeight: FontWeight.w500
                    )),
                  ),
                  onTap: () {
...
// Show a Cupertino-style dialog box
      ...
      showCupertinoDialog(
        ...
        builder: (BuildContext context) => CupertinoAlertDialog(
          ...
          content: TextStyleExample(
            name: 'Your current location will be displayed on the map and used for directions,nearby search results, and estimated travel times',
            style: textTheme.titleSmall!,
          ),
